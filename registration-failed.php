...
<div id='bg' style='display:none;' onclick='javascript:hide_overlay()'></div>
          ...
          <div id="registration" class="registration">
                  ...
                  <div class="formFacebook">
                    <div id="fbimage"><fb:login-button data-size="xlarge" data-show-faces="false" data-auto-logout-link="false" scope="public_profile,email" onlogin="checkLoginState();"></fb:login-button>
                    </div>
                  </div>
