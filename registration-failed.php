...
<div id='bg' style='display:none;' onclick='javascript:hide_overlay()'></div>
            ...
            <div id="ask_name" style="display:none;" class="alert">
              <h2 id="inline1_sub"><font color="red">Registration</font></h2>
              <form id="loginForm" name="loginForm" method="post" action="register-exec.php">
                 <font color="red">First Name</font><input name="fname" type="text" class="textfield" id="fname" />
                 <font color="red">Last Name</font><input name="lname" type="text" class="textfield" id="lname" />
                 ...
                 <font color="red">Confirm Password</font><input name="cpassword" type="password" class="textfield" id="cpassword" />
                 <br />
